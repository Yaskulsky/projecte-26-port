...
| NeoForge | Required | `26.1.2.7-beta` or newer (`[26.1.2,)`) |

### Logo

Use `src/main/resources/logo.png` from the repo (allowed under MIT with attribution).

---

## CurseForge — full description (HTML)
...
<h2>Features</h2>
<ul>
  <li>Transmutation table, collectors, condensers, relays</li>
  <li>Rings, amulets, armor, and tools</li>
  <li>EMC system — convert items to energy and back</li>
  <li>MC <strong>26.1.2</strong> / NeoForge <strong>26.1.2+</strong></li>
</ul>

<h2>Requirements</h2>
<ul>
  <li>Minecraft <strong>26.1.2</strong></li>
