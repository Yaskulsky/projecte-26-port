...
import com.yaskulsky.equivox.api.event.EMCRemapEvent;
...
import com.yaskulsky.equivox.emc.arithmetic.HiddenBigFractionArithmetic;
import com.yaskulsky.equivox.emc.collector.DumpToFileCollector;
import com.yaskulsky.equivox.emc.collector.LongToBigFractionCollector;
import com.yaskulsky.equivox.emc.components.DataComponentManager;
import com.yaskulsky.equivox.emc.generator.BigFractionToLongGenerator;
import com.yaskulsky.equivox.emc.mappers.TagMapper;
import com.yaskulsky.equivox.emc.pregenerated.PregeneratedEMC;
...
public final class EMCMappingHandler {
	...
	public static void map(ReloadableServerResources serverResources, RegistryAccess registryAccess, ResourceManager resourceManager) {
		...
		if (MappingConfig.dumpToFile()) {
			mappingCollector = new DumpToFileCollector<>(EquivoxConfig.CONFIG_DIR.resolve("mapping_dump.json"), mappingCollector);
		}

		boolean usePregenerated = MappingConfig.usePregenerated();
		Path pregeneratedEmcFile = EquivoxConfig.CONFIG_DIR.resolve("pregenerated_emc.json");
