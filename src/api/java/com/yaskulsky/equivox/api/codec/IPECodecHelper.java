package com.yaskulsky.equivox.api.codec;
...
public interface IPECodecHelper {
	...
	/**
	 * Helper for dealing with {@link Codec Codecs} related to Equivox.
	 */
	IPECodecHelper INSTANCE = ServiceLoader.load(IPECodecHelper.class).findFirst()
			.orElseThrow(() -> new IllegalStateException("No valid ServiceImpl for IPECodecHelper found, Equivox may be absent, damaged, or outdated"));
