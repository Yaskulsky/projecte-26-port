package com.yaskulsky.equivox.api.components;
...
public interface IComponentProcessorHelper {
	...
	IComponentProcessorHelper INSTANCE = ServiceLoader.load(IComponentProcessorHelper.class).findFirst()
			.orElseThrow(() -> new IllegalStateException("No valid ServiceImpl for IComponentProcessorHelper found, Equivox may be absent, damaged, or outdated"));
