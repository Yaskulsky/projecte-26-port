package com.yaskulsky.equivox.api.mapper.recipe;

import com.yaskulsky.equivox.api.config.IConfigurableElement;
...
public interface IRecipeTypeMapper extends IConfigurableElement {
	 ...
	 * @implNote Due to how the fakeGroupManager works, {@link com.yaskulsky.equivox.api.nss.NSSFake} implementations should only be created in this method with
