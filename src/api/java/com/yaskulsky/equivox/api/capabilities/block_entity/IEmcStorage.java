package com.yaskulsky.equivox.api.capabilities.block_entity;
 ...
 * <p>
 * The contract of this interface is only the above statement However, Equivox implements an "active-push" system, where providers automatically send EMC to acceptors.
...
public interface IEmcStorage {
	 ...
	 *
	 * @implNote If two neighboring {@link IEmcStorage}s are both relays, Equivox's blocks (relays) will not try send Emc to each other. This is to prevent thrashing.
	 */
