...
abstract class UpdateJson extends DefaultTask {
    ...
    UpdateJson() {
        ...
        modVersion = providerFactory.gradleProperty('equivox_version')
    ...
    void execute() {
        ...
        versionData[modVersion] = "See https://github.com/Yaskulsky/projecte-26-port/releases for detailed information."
